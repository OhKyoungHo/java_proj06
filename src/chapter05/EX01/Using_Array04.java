...
public class Using_Array04 {
	...
	public static void main(String[] args) {
		/* 배열(Array) : 하나의 [배열] 변수에 여러개의 값을 넣는다.
				- 참조자료형 : 변수는 Stack에 저장, 값은 Heap 에 저장
		...
		int[] a = new int[5];
			//int 배열 변수([]) a를 생성
			//new : Heap 공간에 int 배열 방 5개를 생성해서 Heap의 주소를 a 변수에 할당	
		...
		System.out.println("=====for를 사용해서 값을 입력, 출력=====");					//값을 인풋!
		...
		for(int k : a) {						//k는 각 a 배열에서 나온 값을 담는 변수
